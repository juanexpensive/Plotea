...
class MediaStatusRepository(IMediaStatusRepository):
    ...
    async def get(self, user_id: int, tmdb_id: int, media_type: str) -> MediaStatus | None:
        model = await self._get_model(user_id, tmdb_id, media_type)
    ...
    async def delete(self, user_id: int, tmdb_id: int, media_type: str) -> None:
        await self._session.execute(
            delete(UserMediaStatusModel).where(
