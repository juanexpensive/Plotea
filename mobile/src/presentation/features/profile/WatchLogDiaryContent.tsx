...
export function WatchLogDiaryContent({
  items,
  loading,
  deletingId,
  error,
    ...
    <View style={styles.content}>
      ...
      {items.length === 0 ? (
        <View style={styles.emptyState}>
          <Text style={styles.emptyTitle}>Todavia no has registrado nada.</Text>
          <Text style={styles.emptyText}>Cuando anadas tu primera entrada, aparecera aqui.</Text>
        </View>
      ) : (
